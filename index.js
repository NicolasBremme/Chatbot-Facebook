...
function checkURL(user, text)
{
    ...
    if (user.urlEntered == 0 && validUrl.isUri(text)){
        ...
        sendTextMessage(user, { text: "Pick one", "quick_replies" : [ { "content_type": "text", "title": "one", "image_url": "https://cybersavoir.csdm.qc.ca/bibliotheques/files/2018/11/10_banques_dimages_gratuites_libres_de_droits-300x169.jpg"}, { "content_type": "text", "title": "two", "image_url": "https://cybersavoir.csdm.qc.ca/bibliotheques/files/2018/11/10_banques_dimages_gratuites_libres_de_droits-300x169.jpg"} ] } );
        user.urlEntered = 1;
