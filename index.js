        ...
        kuratorRequest("/api/getArticleInfo", reqParam, function(err, res, body) {
            try {
                ...
                if (body.hasError == false && body.parseError == false) {
                    ...
                    sendTextMessage(allUsers[sender], [{attachment: {type: "image", payload: {url: kuratorUrl + "/img/posteria/kurator_no_gbest-publication.jpg"}}}, {text: kuratorUrl + '?extern_id=' + sender}], 0, 1, sendTextMessage);
                }
                else {
